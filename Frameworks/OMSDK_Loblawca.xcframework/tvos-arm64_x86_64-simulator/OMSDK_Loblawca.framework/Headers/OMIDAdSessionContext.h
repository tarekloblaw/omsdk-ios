 ...
 */
@interface OMIDLoblawcaAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDLoblawcaPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDLoblawcaPartner *)partner
                               ...
                               resources:(NSArray<OMIDLoblawcaVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDLoblawcaPartner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDLoblawcaUniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
