 ...
 */
@interface OMIDLoblawcaAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDLoblawcaAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDLoblawcaVASTProperties *_Nonnull)vastProperties
